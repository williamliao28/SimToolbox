...
class CPSolver {
  public:
    ...
    /**
     * @brief Read A generated by the constructor from file for internal test
     *
     * @param filename
     */
    CPReadA(std::string filename);

    /**
     * @brief Read b generated by the constructor from file for internal test
     *
     * @param filename
     */
    CPReadb(std::string filename);
